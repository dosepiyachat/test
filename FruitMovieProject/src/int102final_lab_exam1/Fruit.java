...
public class Fruit {
     ...
     * @param quality คุณภาพ โดยให้คุณภาพเป็น 1 ถ้าส่งคุณภาพมาน้อยกว่า 1
     * และให้คุณภาพเป็น 10 ถ้าส่งคุณภาพมาเกิน 10
     */
...
//        this.quality = (quality < 1) ? 1 : (quality > 10) ? 10 : quality;
     ...
     *
     * @param f ผลไม้อื่น
     * @return true ถ้าเป็นผลไม้ชื่อเดียวกัน ราคาเท่ากัน และคุณภาพเท่ากัน; false
     * ถ้า f เป็น null หรือ f มีชื่อ ราคา หรือคุณภาพ แตกต่างจากผลไม้นี้
     */
